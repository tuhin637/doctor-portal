...
class doctor
{
    ...
    void new_doctor()
    {
        ...
        droom = input.nextInt();
        System.out.print("Decission marking:-");
        droom = input.nextInt();
        System.out,print("Data mining:-");
        droom= input.nextInt();
        System.out.print("weather foreceasting:-");
        droom = input.nextInt();
        System.out.print("pattern discovry:-");
        door = input.nextInt();
        System.out.print("Better decission making:-")
        door = input.nextInt();
        System.out.print("hypothies test")
